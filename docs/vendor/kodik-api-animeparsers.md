<!--
  Vendored copy for offline reference in orinuno (not official Kodik docs).
  Source: https://github.com/YaNesyTortiK/AnimeParsers/blob/main/KODIK_API.md
  Raw:    https://raw.githubusercontent.com/YaNesyTortiK/AnimeParsers/main/KODIK_API.md
  Snapshot date (UTC): 2026-04-12
  Upstream states this is community reverse-engineering, not official API documentation.
-->
