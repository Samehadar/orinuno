<!--
  Vendored copy for offline reference in orinuno.
  Source: https://github.com/negezor/kodik-api-rust/blob/master/README.md
  Raw:    https://raw.githubusercontent.com/negezor/kodik-api-rust/master/README.md
  Crates.io: https://crates.io/crates/kodik-api
  docs.rs: https://docs.rs/kodik-api/latest/kodik_api/
  Snapshot date (UTC): 2026-04-12
  Unofficial Rust wrapper for Kodik API (not affiliated with Kodik).
-->
