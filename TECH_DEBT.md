...
**Reference:** upstream-source parser in downstream-repo uses RabbitMQ + State Machine for this. For a standalone service, a simpler REST-based job polling pattern is preferred.
