...
public class DecoderHealthTracker {
    ...
    @Getter
    private final AtomicLong totalDecoded = new AtomicLong(0);
    @Getter
    private final AtomicLong totalFailed = new AtomicLong(0);
    @Getter
    private final AtomicReference<String> lastFailureStep = new AtomicReference<>(null);
    @Getter
    ...
    public DecoderHealthTracker(MeterRegistry meterRegistry) {
        this.successCounter = Counter.builder("kodik.decoder.success")
                .description("Successful decode operations")
                .register(meterRegistry);
        this.failureCounter = Counter.builder("kodik.decoder.failure")
