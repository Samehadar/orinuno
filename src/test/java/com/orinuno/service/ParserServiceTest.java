...
class ParserServiceTest {
    ...
    @Mock
    private KodikApiClient kodikApiClient;
    @Mock
    private ContentService contentService;
    @Mock
    private KodikVideoDecoderService decoderService;
    @Mock
    ...
    void setUp() {
        ...
        parserService = new ParserService(kodikApiClient, contentService, decoderService,
                episodeVariantRepository, properties);
    }

    @Test
    @DisplayName("Should process search results and save content")
    void shouldProcessSearchResults() {
        KodikSearchResponse.Result result = KodikSearchResponse.Result.builder()
                .id("movie-1")
                .type("foreign-movie")
                .title("Test")
                .kinopoiskId("123")
                .translation(KodikSearchResponse.Translation.builder()
                        .id(1).title("Дубляж").type("voice").build())
                .build();

        KodikSearchResponse response = KodikSearchResponse.builder()
                .total(1)
