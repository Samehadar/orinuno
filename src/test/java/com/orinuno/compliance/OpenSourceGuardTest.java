...
class OpenSourceGuardTest {
    ...
    private static final List<String> FORBIDDEN_STRINGS =
            List.of("corporate", "downstream-repo", "com.example.parser");

    private static final Pattern FORBIDDEN_PATTERN =
            Pattern.compile(String.join("|", FORBIDDEN_STRINGS), Pattern.CASE_INSENSITIVE);
    ...
    void sourceCodeShouldNotContainProprietaryReferences() throws IOException {
        ...
        assertThat(violations).as("Proprietary references found in source code").isEmpty();
    }
