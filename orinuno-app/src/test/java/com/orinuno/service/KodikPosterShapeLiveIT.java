 ...
 * SourceContentInfo} without a poster URL, the downstream consumer download path becomes a no-op, and
        ...
        assertThat(info.posterUrl())
                .as(
                        "ARCH-0017-FOLLOWUP-POSTER drift probe: Kodik no longer exposes"
                                ...
                                + " drama_poster_url in material_data — the downstream consumer MinIO"
