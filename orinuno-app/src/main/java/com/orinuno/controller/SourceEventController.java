 ...
 * SourceCatalogEvent}s. Open consumers (Kin's {@code external-bridge}, future OSS aggregators)
 ...
 * available throughout this PR for kodik-parser back-compat. It will be retired once Stage C
...
@Tag(
        ...
        description =
                "Producer-side SourceCatalogEvent stream — orinuno's open contract for any"
                        + " consumer (Kin meter, OSS aggregators) to ingest source catalog state.")
