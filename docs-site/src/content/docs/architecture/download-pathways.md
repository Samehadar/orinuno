...
| Embed endpoint returns 503 | `error: registry empty` | Token registry empty | See [downstream consumer integration → §1](/orinuno/operations/downstream-integration/#1-pre-flight-checklist) |
...
- [downstream consumer integration](/orinuno/operations/downstream-integration/) — observability and rate-limit context
