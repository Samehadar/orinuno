...
| Embed endpoint returns 503 | `error: registry empty` | Token registry empty | See [downstream integration → §1](/orinuno/operations/downstream-integration/#1-pre-flight-checklist) |
...
- [downstream integration](/orinuno/operations/downstream-integration/) — observability and rate-limit context
