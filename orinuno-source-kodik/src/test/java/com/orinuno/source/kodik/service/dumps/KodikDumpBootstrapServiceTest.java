...
class KodikDumpBootstrapServiceTest {
    ...
    private ContentWriteService contentService;
    ...
    void setUp() {
        ...
        properties.setDownloadBody(true);

        contentService = mock(ContentWriteService.class);
        ...
        service = new KodikDumpBootstrapService(properties, contentService);
    }
    ...
    void bootstrapRefusesWhenDownloadBodyDisabled() {
        properties.setDownloadBody(false);
    ...
    void buildUrlNormalisesTrailingSlash() {
        properties.setBaseUrl("https://dumps.kodikres.com/");
        KodikDumpsProperties.DumpEntry entry =
                new KodikDumpsProperties.DumpEntry(true, "films.json");
