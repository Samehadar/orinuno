...
import com.orinuno.source.kodik.service.decoder.KodikDecodeOrchestrator;
import com.orinuno.source.kodik.service.metrics.KodikCdnHostMetrics;
...
class ParserServiceTest {
    ...
    @Mock private ContentWriteService contentService;
    ...
    @BeforeEach
    void setUp() {
        KodikDecoderProperties properties = new KodikDecoderProperties();
    ...
    void refreshExpiredLinksHonoursMaxBatchPerTick() {
        KodikDecoderProperties props = new KodikDecoderProperties();
        props.setRequestDelayMs(0);
        props.setRefreshBatchSize(50);
        props.getMaintenance().setMaxBatchPerTick(3);
        props.getMaintenance().setTickTimeoutSeconds(5);
        ...
        verify(episodeVariantRepository).findExpiredLinks(props.getLinkTtlHours(), 3);
    ...
    void retryFailedDecodesHonoursMaxBatchPerTick() {
        ...
        props.setRequestDelayMs(0);
        props.setRefreshBatchSize(50);
        props.getMaintenance().setMaxBatchPerTick(2);
        ParserService bounded =
                new ParserService(
                        kodikApiClient,
                        contentService,
    ...
    void refreshExpiredLinksAbortsOnTickTimeout() {
        KodikDecoderProperties props = new KodikDecoderProperties();
        props.setRequestDelayMs(0);
        props.setRefreshBatchSize(2);
        props.getMaintenance().setMaxBatchPerTick(2);
        props.getMaintenance().setTickTimeoutSeconds(1);
        ParserService bounded =
                new ParserService(
                        kodikApiClient,
                        contentService,
