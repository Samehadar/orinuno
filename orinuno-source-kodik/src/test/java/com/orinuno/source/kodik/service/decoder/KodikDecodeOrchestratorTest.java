...
class KodikDecodeOrchestratorTest {
    ...
    private KodikDecoderProperties properties;
    ...
    void setUp() {
        ...
        properties = new KodikDecoderProperties();
        properties.setSniffFallbackEnabled(true);
    ...
    void sniffDisabledByConfig() {
        properties.setSniffFallbackEnabled(false);
