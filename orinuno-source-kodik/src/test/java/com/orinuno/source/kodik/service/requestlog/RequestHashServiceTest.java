/*
 * RequestHashServiceTest — ADR 0021 §D1a invariant.
 *
 * Pins the canonical-JSON SHA-256 hashing contract for ParseRequestDto.
 * Ported from orinuno-app's RequestHashServiceTest verbatim — same
 * payload shapes, same assertions.
 */
