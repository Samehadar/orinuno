...
import com.orinuno.source.kodik.configuration.KodikRequestsProperties;
...
import com.orinuno.source.kodik.service.ParserService;
...
public class RequestWorker {
    ...
    private final KodikRequestsProperties requestsProperties;
    ...
    private void process(Long requestId) {
        ...
        Duration flush = Duration.ofMillis(requestsProperties.getProgressFlushMs());
