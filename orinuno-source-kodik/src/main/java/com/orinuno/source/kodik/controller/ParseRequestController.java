...
import com.orinuno.source.kodik.service.requestlog.ParseRequestService;
...
@Tag(
        name = "ParseRequests",
        description =
                "Async parse-request log: submit a request and poll completion. downstream consumer"
                        + " must not poll status here — use GET /api/v1/export/ready?updatedSince=")
