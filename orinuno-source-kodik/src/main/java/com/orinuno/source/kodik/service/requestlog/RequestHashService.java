/*
 * RequestHashService — ADR 0021 §D-prep.
 *
 * Canonical-JSON SHA-256 over ParseRequestDto for de-duping active queue
 * rows. Pure utility — ported verbatim from orinuno-app/.../requestlog/.
 */
