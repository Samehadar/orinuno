/*
 * ParseRequestQueueService — ADR 0021 §D1a.
 *
 * Transactional facade for claiming queue rows. Lives in its own bean so
 * Spring's @Transactional proxy intercepts the call from RequestWorker
 * (avoids the self-invocation pitfall). Ported verbatim from
 * orinuno-app/.../requestlog/.
 */
