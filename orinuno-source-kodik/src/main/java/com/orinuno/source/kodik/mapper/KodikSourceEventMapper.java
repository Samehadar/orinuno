 ...
 * producer-side {@link SourceCatalogEvent} suitable for exposure on the wire to any catalog
 * consumer (OSS meter aggregator, out-of-tree downstream adapter). Stage B of ARCH-0017.
 *
 * <p>Mapping decisions:
 *
 * <ul>
 ...
 *       column.
 *   <li><b>Movie vs series</b>: whitelist ({@code movie} / {@code foreign-movie} / {@code
 *       soviet-cartoon} / {@code cartoon}). Anything else falls into the series bucket.
