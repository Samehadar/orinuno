...
import com.orinuno.source.kodik.service.requestlog.ProgressReporter;
...
public class ParserService {
    ...
    public void refreshExpiredLinks() {
        int ttlHours = decoderProperties.getLinkTtlHours();
    ...
    private int boundedBatchSize() {
        int rawBatch = decoderProperties.getRefreshBatchSize();
        int cap = decoderProperties.getMaintenance().getMaxBatchPerTick();
    ...
    private Mono<Void> decodeVariant(KodikEpisodeVariant variant) {
        ...
        int maxRetries = decoderProperties.getMaxRetries();
