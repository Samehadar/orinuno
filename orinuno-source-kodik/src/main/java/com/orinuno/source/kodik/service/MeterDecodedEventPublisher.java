 ...
 *
 * Gated by orinuno.source-kodik.meter.base-url — unset = bean missing = no publish.
...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "orinuno.source-kodik.meter", name = "base-url")
public class MeterDecodedEventPublisher {
    ...
    public MeterDecodedEventPublisher(
            ...
            @Value("${orinuno.source-kodik.meter.base-url}") String baseUrl,
            Clock clock) {
