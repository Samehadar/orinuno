...
import com.orinuno.source.kodik.model.dto.KodikListItemView;
import com.orinuno.source.kodik.model.dto.KodikListPageView;
 ...
 * downstream discovery consumers need (gap-fill, ongoing detection). Tracks whether schema drift
 * was observed during this call so the controller can surface a Warning header.
 */
@Slf4j
@Service
