package com.orinuno.source.kodik.client.calendar;
...
import com.orinuno.source.kodik.service.metrics.KodikCalendarMetrics;
...
public class KodikCalendarHttpClient {
    ...
    public KodikCalendarHttpClient(
        ...
        this.webClient = buildWebClient(calendarProperties);
    }
    ...
    public Mono<CalendarFetchResult> fetch() {
        ...
        long timeoutSeconds = calendarProperties.getRequestTimeoutSeconds();

        WebClient.RequestHeadersSpec<?> request =
                webClient
                        .get()
                        .uri(calendarProperties.getUrl())
    ...
    private Mono<CalendarFetchResult> parseAndRecord(
        ...
        long limit = calendarProperties.getMaxResponseBytes();
