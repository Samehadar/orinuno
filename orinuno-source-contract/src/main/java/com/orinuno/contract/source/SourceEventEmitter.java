 ...
 * CatalogSinkEventEmitter}), enqueue into an outbox for later remote delivery, or post directly to
 * a remote consumer (e.g. the OSS meter aggregator or any out-of-tree downstream).
 *
