 ...
 *
 * <p>Meter does not consume any of these fields today (parser-* services in external aggregator swallow
 * drift internally), so the consumer-side {@code external bridge} drops the whole record on
