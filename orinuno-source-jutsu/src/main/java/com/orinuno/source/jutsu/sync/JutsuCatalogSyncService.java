...
import com.orinuno.source.jutsu.repository.JutsuSyncStateRepository;
...
public class JutsuCatalogSyncService {
    ...
    public NoticeWalkResult runNoticeWalkOnce(int maxFeeds, int maxInfoFetches) {
        JutsuSourceProperties.SyncProperties cfg = props.getSync();
        JutsuSourceProperties.SyncProperties.NoticeWalkProperties nwCfg = cfg.getNoticeWalk();
    ...
    public NoticeWalkResult runNoticeWalkOnce() {
        JutsuSourceProperties.SyncProperties.NoticeWalkProperties nwCfg =
                props.getSync().getNoticeWalk();
